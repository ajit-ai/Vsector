...
def create_index(index_type: str, dimension: int, metric: str = "cosine", **kwargs):
    ...
    if t == "HNSW":
        ...
        return ScaNNIndex(dimension=dimension, metric=metric, num_leaves=kwargs.get("num_leaves", 1024), leaves_to_search=kwargs.get("leaves_to_search", 16), compression=compression)
    elif t == "FLAT":
